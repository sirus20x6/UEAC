...
UNREALROOTPATH = /thearray/git/UnrealEngine
GAMEPROJECTFILE =/thearray/git/UnrealEngine/astrochicken/astrochicken.uproject

TARGETS = \
	astrochicken-Linux-Debug  \
	astrochicken-Linux-DebugGame  \
	astrochicken-Linux-Test  \
	astrochicken-Linux-Shipping  \
	astrochicken \
	astrochickenEditor-Linux-Debug  \
	astrochickenEditor-Linux-DebugGame  \
	astrochickenEditor-Linux-Test  \
	astrochickenEditor-Linux-Shipping  \
	astrochickenEditor \
...
StandardSet: RequiredTools UnrealFrontend astrochickenEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug astrochickenEditor-Linux-Debug


astrochicken-Linux-Debug:
	 $(PROJECTBUILD) astrochicken Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochicken-Linux-DebugGame:
	 $(PROJECTBUILD) astrochicken Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochicken-Linux-Test:
	 $(PROJECTBUILD) astrochicken Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochicken-Linux-Shipping:
	 $(PROJECTBUILD) astrochicken Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochicken:
	 $(PROJECTBUILD) astrochicken Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochickenEditor-Linux-Debug:
	 $(PROJECTBUILD) astrochickenEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochickenEditor-Linux-DebugGame:
	 $(PROJECTBUILD) astrochickenEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochickenEditor-Linux-Test:
	 $(PROJECTBUILD) astrochickenEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochickenEditor-Linux-Shipping:
	 $(PROJECTBUILD) astrochickenEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

astrochickenEditor:
	 $(PROJECTBUILD) astrochickenEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
